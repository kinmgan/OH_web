...
export default function CreateHomepageSectionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await homepageSectionAdminService.createSection({
        title: title.trim(),
        type,
      ...
      setError(err.message || 'Đã xảy ra lỗi khi tạo khối');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 700 }}>Thêm khối mới</h1>
      </div>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p style={{ fontSize: '12px', color: '#888', marginTop: '4px' }}>
              Admin tự do đặt tên theo ý muốn
            </p>
          </div>
          ...
          {/* Category Picker - only show when type is CATEGORY */}
          {type === 'CATEGORY' && (
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, marginBottom: '6px' }}>
